...
import CloudinaryVideo from '/components/blocks/cloudinary-video'
...
<TwitterTweetEmbed tweetId="1402853959149056001" hire options={{ conversation: 'none' }} />
...
<figure>
  <Image
    ...
    className="rounded-2xl object-cover"
  />
  <figcaption>A plastic storage case with some acoustic foam. Hey, it worked wonders!</figcaption>
</figure>
...
- A **bookshelf full of books** is also a fabulous choice for many of the same reasons (maybe not the chill spot one). That, and you'll appear very cultivated.

  The shelf itself will likely by a hard surface, but it will still deflect the bouncing soundwaves. And all the paper in those books will **devour room reverb** for you.
...
<figure>
  <Image src={diy4} width={800} height={600} alt="" className="rounded-2xl object-cover" />
...
<CloudinaryVideo url="https://player.cloudinary.com/embed/?public_id=v1648767128%2Fbetter-dev%2Froom-sound-treatment%2Fsound-blanket-installation.mp4&cloud_name=simonswiss&player%5Bfluid%5D=true&player%5Bcontrols%5D=true&player%5Bposter_options%5D%5Btransformation%5D%5Bstart_offset%5D=18&source%5Bsource_types%5D%5B0%5D=mp4" />

Notice the Swiss 🇨🇭 engineering precision with those measurements.
...
<TwitterTweetEmbed tweetId="1402804338326532096" />
